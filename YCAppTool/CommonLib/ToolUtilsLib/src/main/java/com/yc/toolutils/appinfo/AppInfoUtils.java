package com.yc.toolutils.appinfo;
...
import com.yc.toolutils.clean.AppCleanUtils;
...
public final class AppInfoUtils {
    ...
    public static String getAppPackageName() {
        return AppToolUtils.getApp().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(AppToolUtils.getApp().getPackageName());
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(AppToolUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(AppToolUtils.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(AppToolUtils.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(AppToolUtils.getApp().getPackageName());
    }
    ...
    public static boolean isSystemApp() {
        return isSystemApp(AppToolUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(AppToolUtils.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(AppToolUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ActivityManager manager =
                (ActivityManager) AppToolUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(AppToolUtils.getApp().getPackageName());
            }
        }
        return false;
    }
