...
public final class AppSpUtils {
    ...
    private static final SimpleArrayMap<String, AppSpUtils> SP_UTILS_MAP = new SimpleArrayMap<>();
    ...
    private AppSpUtils(final String spName) {
        sp = AppToolUtils.getApp().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }
